...
public class KaraokeApp {
    ...
    public static void runKaraokeMachine(Scanner scanner, String userChoice, Player musicPlayer, Player lyricsPlayer, Album album) {
        ...
        if (userChoice.equalsIgnoreCase("k")) {
            lyricsPlayer.play(album);
        } else {
            musicPlayer.play(album);
        }
    }
